...
1. **turbine-01** 블레이드의 **기본 키** 오른쪽에 있는 **복사**를 클릭하여 나중에 사용할 수 있도록 키 값을 저장합니다.
    ...
    ![Azure IoT 보안 모듈 스크린샷](media/LAB05_module-identity.png)
...
1. Azure Portal 도구 모음에서 **Cloud Shell**을 클릭합니다.![](media/cloudshell01.png)
...
1. 이제 **모듈 ID** 아래에 **azureiotsecurity** 모듈의 상태가 **Connected**로 표시됩니다.
    ...
    ![연결된 Azure IoT 보안 모듈 스크린샷](media/azuresecurity.png)
...
1. 왼쪽 메뉴의 **보안** 아래에서 **개요**를 클릭합니다. 
    ...
    ![Azure IoT 보안 모듈 스크린샷](media/LAB_AK_05-security-dashboard.png)
...
1. 왼쪽 메뉴의 **보안** 아래에서 **개요**를 클릭합니다.
    ...
    **위협 검색** 섹션을 확인합니다. **디바이스 보안 경고** 차트에 경고가 하나 이상 표시되어야 합니다.
    ...
    ![디바이스 보안 경고 차트](media/LAB_AK_05-device-security-alert-chart.png)
...
1. **위협 검색** 아래에서 **경고가 가장 많은 디바이스** 타일을 클릭합니다.
    ...
    ![보안 경고 목록](media/device_security_alert.png)
